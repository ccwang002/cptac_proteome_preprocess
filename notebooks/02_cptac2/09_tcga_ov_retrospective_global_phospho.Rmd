...
raw_phospho_row_tbl %>%
    ...
    write_tsv('~/Box/MyCPTAC/CPTAC_data_collection_v1/CPTAC2/TCGA_OV_retrospective/mmc3_phosphoproteome_ischemia_filtered_peptide_annotation.tsv.gz')
```
...
## Export
```{r}
protein_se %>% saveRDS(here('final_output/TCGA_OV_retrospective/TCGA_OV_retrospective_pnnl_proteome.rds'))
phospho_se %>% saveRDS(here('final_output/TCGA_OV_retrospective/TCGA_OV_retrospective_pnnl_phosphoproteome.rds'))
```