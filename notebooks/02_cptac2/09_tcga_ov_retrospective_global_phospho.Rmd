...
```{r}
uniprot2020_03_coord_mapping_tbl = read_refseq20111201_to_uniprot2020_03_coord_mapping()
```
...
raw_phospho_row_tbl %>%
    ...
    write_tsv('~/Box/MyCPTAC/CPTAC_proteome_v1/CPTAC2/TCGA_OV_retrospective/mmc3_phosphoproteome_ischemia_filtered_peptide_annotation.tsv.gz')
```
