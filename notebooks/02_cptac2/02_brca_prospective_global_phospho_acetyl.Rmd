...
phospho_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_prospective/prosp-brca-v5.3-phosphoproteome-ratio-norm-NArm.gct')
phospho_loc_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_prospective/prosp-brca-v5.3-phosphoproteome-ratio-norm-NArm.peptide_location.tsv.gz')

acetyl_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_prospective/prosp-brca-v5.3-acetylome-ratio-norm-NArm.gct')
acetyl_loc_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_prospective/prosp-brca-v5.3-acetylome-ratio-norm-NArm.peptide_location.tsv.gz')
