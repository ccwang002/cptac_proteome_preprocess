...
```{r}
protein_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_discovery/prosp-brca-v5.3-proteome-ratio-norm-NArm.gct')

phospho_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_discovery/prosp-brca-v5.3-phosphoproteome-ratio-norm-NArm.gct')
phospho_loc_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_discovery/prosp-brca-v5.3-phosphoproteome-ratio-norm-NArm.peptide_location.tsv.gz')

acetyl_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_discovery/prosp-brca-v5.3-acetylome-ratio-norm-NArm.gct')
acetyl_loc_pth = fs::path(DATA_ROOT, 'CPTAC2/BRCA_discovery/prosp-brca-v5.3-acetylome-ratio-norm-NArm.peptide_location.tsv.gz')
...
## Export
```{r}
protein_se %>% saveRDS(here('final_output/CPTAC2_BRCA_prospective/CPTAC2_BRCA_prospective_broad_proteome.rds'))
phospho_se %>% saveRDS(here('final_output/CPTAC2_BRCA_prospective/CPTAC2_BRCA_prospective_broad_phosphoproteome.rds'))
acetyl_se %>% saveRDS(here('final_output/CPTAC2_BRCA_prospective/CPTAC2_BRCA_prospective_broad_acetylome.rds'))
```
