...
```{r}
DATA_ROOT = '~/Box/MyCPTAC/CPTAC_proteome_v1.1'
```

```{r}
protein_pth = fs::path(DATA_ROOT, 'CPTAC3/LSCC_discovery/lscc-v3.2-proteome-ratio-norm-NArm.gct')

phospho_pth = fs::path(DATA_ROOT, 'CPTAC3/LSCC_discovery/lscc-v3.2-phosphoproteome-ratio-norm-NArm.gct')
phospho_loc_pth = fs::path(DATA_ROOT, 'CPTAC3/LSCC_discovery/lscc-v3.2-phosphoproteome-ratio-norm-NArm.peptide_location.tsv')

acetyl_pth = fs::path(DATA_ROOT, 'CPTAC3/LSCC_discovery/lscc-v3.2-acetylome-ratio-norm-NArm.gct')
acetyl_loc_pth = fs::path(DATA_ROOT, 'CPTAC3/LSCC_discovery/lscc-v3.2-acetylome-ratio-norm-NArm.peptide_location.tsv')

ubiquitin_pth = fs::path(DATA_ROOT, 'CPTAC3/LSCC_discovery/lscc-v3.2-ubiquitylome-ratio-norm-NArm.gct')
ubiquitin_loc_pth = fs::path(DATA_ROOT, 'CPTAC3/LSCC_discovery/lscc-v3.2-ubiquitylome-ratio-norm-NArm.peptide_location.tsv')
```
...
## Export
```{r}
protein_se %>% saveRDS(here('final_output/CPTAC3_LSCC_discovery/CPTAC3_LSCC_discovery_broad_proteome.rds'))
phospho_se %>% saveRDS(here('final_output/CPTAC3_LSCC_discovery/CPTAC3_LSCC_discovery_broad_phosphoproteome.rds'))
acetyl_se %>% saveRDS(here('final_output/CPTAC3_LSCC_discovery/CPTAC3_LSCC_discovery_broad_acetylome.rds'))
ubiquitin_se %>% saveRDS(here('final_output/CPTAC3_LSCC_discovery/CPTAC3_LSCC_discovery_broad_ubiquitylome.rds'))
```
