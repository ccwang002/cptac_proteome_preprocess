...
phospho_se %>% saveRDS(here('final_output/CPTAC3_LUAD_discovery/CPTAC3_LUAD_discovery_broad_phosphoproteome.v2.0.rds'))
acetyl_se %>% saveRDS(here('final_output/CPTAC3_LUAD_discovery/CPTAC3_LUAD_discovery_broad_acetylome.v2.0.rds'))
```
