...
## Export
```{r}
protein_se %>% saveRDS(here('final_output/CPTAC3_LUAD_discovery/CPTAC3_LUAD_discovery_broad_proteome.rds'))
phospho_se %>% saveRDS(here('final_output/CPTAC3_LUAD_discovery/CPTAC3_LUAD_discovery_broad_phosphoproteome.rds'))
acetyl_se %>% saveRDS(here('final_output/CPTAC3_LUAD_discovery/CPTAC3_LUAD_discovery_broad_acetylome.rds'))
```
