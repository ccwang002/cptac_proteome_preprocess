...
phospho_pth = fs::path(DATA_ROOT, 'CPTAC3/LUAD_discovery/luad-v3.1-phosphoproteome-ratio-norm-unfiltered.gct')
phospho_loc_pth = fs::path(DATA_ROOT, 'CPTAC3/LUAD_discovery/luad-v3.1-phosphoproteome-ratio-norm-unfiltered.peptide_location.tsv')

acetyl_pth = fs::path(DATA_ROOT, 'CPTAC3/LUAD_discovery/luad-v3.1-acetylome-ratio-norm-unfiltered.gct')
acetyl_loc_pth = fs::path(DATA_ROOT, 'CPTAC3/LUAD_discovery/luad-v3.1-acetylome-ratio-norm-unfiltered.peptide_location.tsv')
```
...
# Make sure all the protein samples are in the phospho data
setdiff(rownames(colData(raw_phospho_se)), protein_col_tbl$preferred_sample_name)
```

Based on README, `C3N-00545` is excluded. Instead of averaging replicates, we take the first occurrence.
```{r}
...
## Export
```{r}
fs::dir_create(here('final_output/CPTAC3_LUAD_discovery'))
protein_se %>% saveRDS(here('final_output/CPTAC3_LUAD_discovery/CPTAC3_LUAD_discovery_broad_proteome.v2.0.rds'))
phospho_se %>% saveRDS(here('final_output/CPTAC3_LUAD_discovery/CPTAC3_LUAD_discovery_broad_phosphoproteome.v2.2.rds'))
acetyl_se %>% saveRDS(here('final_output/CPTAC3_LUAD_discovery/CPTAC3_LUAD_discovery_broad_acetylome.v2.2.rds'))
```
