...
phospho_se %>% saveRDS(here('final_output/CPTAC3_GBM_discovery/CPTAC3_GBM_discovery_pnnl_phosphoproteome.v2.0.rds'))
acetyl_se %>% saveRDS(here('final_output/CPTAC3_GBM_discovery/CPTAC3_GBM_discovery_pnnl_acetylome.v2.0.rds'))
```
