...
## Export
```{r}
protein_se %>% saveRDS(here('final_output/CPTAC3_GBM_discovery/CPTAC3_GBM_discovery_pnnl_proteome.rds'))
phospho_se %>% saveRDS(here('final_output/CPTAC3_GBM_discovery/CPTAC3_GBM_discovery_pnnl_phosphoproteome.rds'))
acetyl_se %>% saveRDS(here('final_output/CPTAC3_GBM_discovery/CPTAC3_GBM_discovery_pnnl_acetylome.rds'))
```