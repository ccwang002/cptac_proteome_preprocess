...
phospho_se %>% saveRDS(here('final_output/CPTAC3_UCEC_discovery/CPTAC3_UCEC_discovery_pnnl_phosphoproteome.v2.0.rds'))
acteyl_se %>% saveRDS(here('final_output/CPTAC3_UCEC_discovery/CPTAC3_UCEC_discovery_pnnl_acetylome.v2.0.rds'))
```
