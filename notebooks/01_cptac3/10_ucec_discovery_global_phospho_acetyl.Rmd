...
## Export
```{r}
protein_se %>% saveRDS(here('final_output/CPTAC3_UCEC_discovery/CPTAC3_UCEC_pnnl_proteome.rds'))
phospho_se %>% saveRDS(here('final_output/CPTAC3_UCEC_discovery/CPTAC3_UCEC_pnnl_phosphoproteome.rds'))
acteyl_se %>% saveRDS(here('final_output/CPTAC3_UCEC_discovery/CPTAC3_UCEC_pnnl_acetylome.rds'))
```