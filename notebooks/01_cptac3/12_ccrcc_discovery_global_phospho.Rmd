...
## Export
```{r}
protein_se %>% saveRDS(here('final_output/CPTAC3_CCRCC_discovery/CPTAC3_CCRCC_umich_proteome.rds'))
phospho_se %>% saveRDS(here('final_output/CPTAC3_CCRCC_discovery/CPTAC3_CCRCC_umich_phosphoproteome.rds'))
```