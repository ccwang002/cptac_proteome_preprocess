...
tmt_map_tbl = read_csv(tmt_pth, col_types = cols(Data.Set = col_integer())) %>%
    ...
    mutate(preferred_sample_name = aliquot_id)
...
## Export
```{r}
protein_se %>% saveRDS(here('final_output/CPTAC3_CCRCC_discovery/CPTAC3_CCRCC_discovery_umich_proteome.rds'))
phospho_se %>% saveRDS(here('final_output/CPTAC3_CCRCC_discovery/CPTAC3_CCRCC_discovery_umich_phosphoproteome.rds'))
```
