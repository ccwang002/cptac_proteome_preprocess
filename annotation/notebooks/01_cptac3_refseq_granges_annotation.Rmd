---
title: "Make Genomic Annotation of CPTAC3 RefSeq 20180628"
output:
  html_document:
    df_print: paged
---
...
Read annotation files downloaded from DCC:
```{r}
REFSEQ_IDS_TSV_PTH = '~/Box/Projects/2020_CPTAC_data_collection/DCC/RefSeq_20180629/RefSeq.20180629_Human_ucsc_hg38_cpdbnr_mito_264contams.fasta.SGSN.categories.tsv.gz'
REFSEQ_IDS_DF_PTH = '~/Box/Projects/2020_CPTAC_data_collection/DCC/RefSeq_20180629/intermediate_2018-06-29_hg38/2_annotation_files_customProDB/ids.RData'
TXDB_PTH = '~/Box/Projects/2020_CPTAC_data_collection/DCC/RefSeq_20180629/intermediate_2018-06-29_hg38/2_annotation_files_customProDB/txdb.sqlite'
CHRM_REFSEQ_TSV_PTH = '~/Box/Projects/2020_CPTAC_data_collection/DCC/RefSeq_20180629/refseq_hg38_20200503_chrM_only.tsv.gz'
HGNC_PROTEIN_CODING_TSV_PTH = '~/Box/Projects/2020_CPTAC_data_collection/DCC/RefSeq_20180629/intermediate_2018-06-29_hg38/3_annotate_fasta/protein-coding_gene.txt.gz'
```
...
saveRDS(
    refseq_20180629_gr.sorted, 
    here('annotation/custom_sources/cptac3_refseq_20180629/refseq_20180629_human_only_unique_loci_GRanges.rds')
)
saveRDS(
    refseq_20180629_full_grl.sorted,
    here('annotation/custom_sources/cptac3_refseq_20180629/refseq_20180629_human_only_all_loci_GRangesList.rds')
)
```
...
refseq_20180629_unique_anno_tbl %>% 
    write_tsv(here('annotation/custom_sources/cptac3_refseq_20180629/refseq_20180629_human_only_unique_loci.tsv.gz'))

refseq_20180629_full_anno_tbl %>% 
    write_tsv(here('annotation/custom_sources/cptac3_refseq_20180629/refseq_20180629_human_only_all_loci.tsv.gz'))
```
