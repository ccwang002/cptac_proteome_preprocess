...
def make_match_only_coords(alignment):
    ...
    # See https://github.com/biopython/biopython/blob/14bf4f2aef448aff47b7b27cf1387eb4272f61db/Bio/Align/__init__.py#L1051
    m1_starts = []
    m1_ends = []
    m2_starts = []
    m2_ends = []
...
def main(mapping_pth, source_fa_pth, target_fa_pth, out_pth):
    ...
    # Tweak the matrix in BioPython 0.78+ to accomodate unkonwn letters
    # See https://github.com/biopython/biopython/issues/3205
    # m = substitution_matrices.load("BLOSUM62")
    # m = matrix.select(matrix.alphabet + "U")
