---
title: "Create UniProt entry mapping between RefSeq 20160914 and UniProt 2020_03"
output:
    html_document:
        df_print: paged
---
...
Source here is RefSeq 20160914 and Target is UniProt 2020_03
```{r}
...
```{r}
mapping_tbl %>% 
    write_tsv('../tracked_results/mappings/refseq_20160914_to_uniprot_2020_03_mappable.tsv.gz')

source_annotation_tbl.failed %>%
    write_tsv('../tracked_results/mappings/refseq_20160914_to_uniprot_2020_03_not_mappable.tsv.gz')
```
