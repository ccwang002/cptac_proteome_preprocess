---
title: "Create UniProt entry mapping between RefSeq 20130727 and UniProt 2020_03"
output:
    html_document:
        df_print: paged
---
...
Source here is RefSeq 20130727 and Target is UniProt 2020_03
```{r}
source_annotation_tbl = read_tsv(here('annotation/refseq_20130727/tracked_results/refseq_20130727_human_only.tsv.gz'))
target_tbl = read_tsv(here('annotation/mapping_uniprot_2020_03/tracked_results/uniprot_reviewed_human_proteome_hgnc_only.v2020_03.tsv.gz'))
```
...
Add mapping by gene symbol

The remaining annotations will fail the mapping
```{r}
source_annotation_tbl.failed = source_annotation_tbl.remaining %>%
    filter(!refseq_prot_id %in% mapping_tbl.align$refseq_prot_id)

nrow(source_annotation_tbl.failed)
```
...
```{r}
mapping_tbl %>% 
    write_tsv('../tracked_results/mappings/refseq_20130727_to_uniprot_2020_03_mappable.tsv.gz')

source_annotation_tbl.failed %>%
    write_tsv('../tracked_results/mappings/refseq_20130727_to_uniprot_2020_03_not_mappable.tsv.gz')
```
