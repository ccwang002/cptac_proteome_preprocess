---
title: "Create UniProt entry mapping between RefSeq 20111201 and UniProt 2020_04"
output:
    html_document:
        df_print: paged
---
...
Source here is RefSeq 20111201 and Target is UniProt 2020_04
```{r}
source_annotation_tbl = read_tsv(here('annotation/refseq_20111201/tracked_results/refseq_20111201_human_only.tsv.gz'))
target_tbl = read_tsv(here('annotation/mapping_uniprot_2020_04/tracked_results/uniprot_reviewed_human_proteome_hgnc_only.v2020_04.tsv.gz'))
```
...
```{r}
mapping_tbl %>% 
    write_tsv('../tracked_results/mappings/refseq_20111201_to_uniprot_2020_04_mappable.tsv.gz')

source_annotation_tbl.failed %>%
    write_tsv('../tracked_results/mappings/refseq_20111201_to_uniprot_2020_04_not_mappable.tsv.gz')
```
