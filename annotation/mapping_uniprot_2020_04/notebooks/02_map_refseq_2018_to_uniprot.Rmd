---
title: "Create UniProt entry mapping between RefSeq 20180629 and UniProt 2020_04"
output:
    html_document:
        df_print: paged
---
...
Source here is RefSeq 20180629 and Target is UniProt 2020_04
```{r}
...
```{r}
mapping_tbl %>% 
    write_tsv('../tracked_results/mappings/refseq_20180629_to_uniprot_2020_04_mappable.tsv.gz')

source_annotation_tbl.failed %>%
    write_tsv('../tracked_results/mappings/refseq_20180629_to_uniprot_2020_04_not_mappable.tsv.gz')
```
