---
title: "Create UniProt entry mapping between RefSeq 20130727 and UniProt 2021_02"
output:
    html_document:
        df_print: paged
---
...
Source here is RefSeq 20130727 and Target is UniProt 2021_02
```{r}
...
```{r}
mapping_tbl %>% 
    write_tsv('../tracked_results/mappings/refseq_20130727_to_uniprot_2021_02_mappable.tsv.gz')

source_annotation_tbl.failed %>%
    write_tsv('../tracked_results/mappings/refseq_20130727_to_uniprot_2021_02_not_mappable.tsv.gz')
```
