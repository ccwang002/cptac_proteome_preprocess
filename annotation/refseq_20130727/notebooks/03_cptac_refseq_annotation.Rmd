...
```{r}
REFSEQ_IDS_TSV_PTH = '~/Box/MyCPTAC/CPTAC_proteome_v1/DCC/RefSeq_20130727/RefSeq.20130727-Human.contams.categories.tsv.gz'
REFSEQ_GENE_ID_MAP_PTH = '~/Box/MyCPTAC/CPTAC_proteome_v1/DCC/RefSeq_20130727/refseq_release60.accession2geneid.gz'
```
